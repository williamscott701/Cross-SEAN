...
def apply_cross_stitch(input_1, input_2):
...
def at_loss(embedder, encoder, clf, batch, addn_batch, ext_batch, perturb_norm_length=5.0):
...
def vat_loss(embedder, encoder, clf, batch, addn_batch, ext_batch, perturb_norm_length=5.0,
